...
def packages():
    cur = mysql.connection.cursor()
    cur.execute("SELECT * FROM " + package_table_name)
...
def users():
    cur = mysql.connection.cursor()
    cur.execute("SELECT * FROM " + user_table_name)
...
def employees():
    cur = mysql.connection.cursor()
    cur.execute("SELECT * FROM " + employee_table_name)
...
def bookings():
    cur = mysql.connection.cursor()
    cur.execute("SELECT * FROM " + booking_table_name)
...
def enquiry():
    cur = mysql.connection.cursor()
    cur.execute("SELECT * FROM " + enquiry_table_name)
